    ...
    <>
      {result === "loading" ? (
        ...
        >
          ...
          <h2 className="text-xl font-medium  px-2 border-y-0 border-r-0 border-4 border-[#115BA2] text-[#115BA2] rounded ">
            Labor Details
          </h2>
          ...
          <div className="px-2 w-full  flex gap-2">
            ...
            <div className="border border-[#eeeeee] border-y-0 border-r-0 gap-4  px-4 w-[40%] flex flex-col my-4">
              <div className="flex flex-col gap-1">
